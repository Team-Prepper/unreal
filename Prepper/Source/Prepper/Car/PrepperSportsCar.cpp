...
#include "PrepperSportsCar.h"
#include "PrepperSportsWheelFront.h"
#include "PrepperSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

APrepperSportsCar::APrepperSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPrepperSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPrepperSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPrepperSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPrepperSportsWheelRear::StaticClass();
