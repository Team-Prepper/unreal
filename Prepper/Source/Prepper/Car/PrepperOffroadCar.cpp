...
#include "PrepperOffroadCar.h"
#include "PrepperOffroadWheelFront.h"
#include "PrepperOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

APrepperOffroadCar::APrepperOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPrepperOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPrepperOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPrepperOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPrepperOffroadWheelRear::StaticClass();
